import { ISPGenericItem } from "classes/types";
...
export class FactorySPItem {
    ...
    static createObject<U, T extends U>(tipo: new () => T, values: ISPGenericItem): T {
    ...
    private static fillProperties<T>(obj: T, valori: ISPGenericItem): T {
